...
const projects = [
  ...
  },
  {
    ...
    technologies: ["React Native", "Context Api", "Node.js", "MongoDB", "Google Firebase", "JWT"],
    category: "Mobile",
    status: "Tamamlandı",
    github: "https://github.com/furkankirci",
    demo: "https://play.google.com/store/apps/details?id=com.pengona.medicineapp",
    githubButton: "Github - Private",
  ...
  },
  {
    ...
    technologies: ["React Native", "MongoDB", "Next.js", "Three.js"],
    category: "Web, Mobile",
  ...
  {
    title: "İçeriği Yönetilebilir Güzellik Salonu Sitesi",
    description:
      "Authorization ve authentication ile jwt tokenlar kullanarak kullanıcının kendi internet sitesini dashboard'ı ile yönetebildiği bir web sitesi",
    technologies: ["Next.js", "MongoDB"],
    category: "Web",
    status: "Tamamlandı",
    github: "https://github.com/furkankirci",
    demo: "https://www.çankayagüzellik.com",
    githubButton: "Github",
    linkButton: "Çankaya Güzellik",
    color: "from-red-500 to-emerald-500",
    icon: Globe,
  },
  {
    title: "CNC Makineleri ve Ürünleri",
    description:
      "CNC makineleri ve ürünleri üzerine, sayfa içeriklerinin dinamik olarak kullanıcı girişi ile yönetildiği. Satış yapılabilen bir e-ticaret ve erp platformu",
    technologies: ["Next.js", "MongoDB"],
    category: "Web",
    status: "Beta ",
    github: "https://github.com/furkankirci",
    demo: "https://cncnova.com",
    githubButton: "Github",
    linkButton: "CNC Nova",
    color: "from-silver-500 to-emerald-500",
    icon: Rocket,
  },
]
